 ...
 *
 * @return A vector of strings containing the UC codes associated with the student.
 */
 ...
 *
 * @return A vector of strings containing the class codes associated with the student.
 */
